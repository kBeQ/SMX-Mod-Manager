...
class ModHelperFrame(ttk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        # Bind mouse wheel recursively AFTER all widgets are created
    ...
    def create_collapsible_pane(self, parent, title, start_expanded=False):
        """Creates a collapsible pane widget and returns the content frame."""
